...
create index guardian_notifications_school_id_idx
  on public.guardian_notifications(school_id);

create index guardian_notifications_student_id_idx
  on public.guardian_notifications(student_id);

create index guardian_notifications_created_at_idx
  on public.guardian_notifications(created_at desc);

create index guardian_notifications_status_idx
