  ...
  public: {
    Tables: {
      ...
      enrollments: {
        ...
        Relationships: [
          {
            foreignKeyName: "enrollments_academic_cycle_id_fkey"
            columns: ["academic_cycle_id"]
            isOneToOne: false
            referencedRelation: "dr_academic_cycles"
            referencedColumns: ["id"]
          },
          {
          ...
          {
            foreignKeyName: "enrollments_subsystem_id_fkey"
            columns: ["subsystem_id"]
            isOneToOne: false
            referencedRelation: "dr_subsystems"
            referencedColumns: ["id"]
          },
          {
      ...
      evaluation_activities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "evaluation_activities_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "app_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "evaluation_activities_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "evaluation_activities_school_year_id_fkey"
            columns: ["school_year_id"]
            isOneToOne: false
            referencedRelation: "school_years"
            referencedColumns: ["id"]
      ...
      evaluation_activity_evidences: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "evaluation_activity_evidences_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      evaluation_activity_group_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "evaluation_activity_group_members_enrollment_id_fkey"
            columns: ["enrollment_id"]
            isOneToOne: false
            referencedRelation: "enrollments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "evaluation_activity_group_members_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      evaluation_activity_groups: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "evaluation_activity_groups_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      grades: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "grades_academic_cycle_id_fkey"
            columns: ["academic_cycle_id"]
            isOneToOne: false
            referencedRelation: "dr_academic_cycles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grades_academic_level_id_fkey"
            columns: ["academic_level_id"]
            isOneToOne: false
            referencedRelation: "dr_academic_levels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "grades_default_modality_id_fkey"
            columns: ["default_modality_id"]
            isOneToOne: false
            referencedRelation: "dr_modalities"
            referencedColumns: ["id"]
          },
