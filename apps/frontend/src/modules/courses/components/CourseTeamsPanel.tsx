  ...
  return (
    <section className="space-y-4">
      ...
      <header className="flex items-center justify-between gap-4">
        ...
        {canManage ? <button type="button" onClick={() => setEditing('new')} className="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-xl bg-primary px-4 text-sm font-extrabold text-primary-foreground shadow-md shadow-primary/20 transition hover:-translate-y-0.5 hover:bg-primary-hover"><UserRoundPlus className="size-4" /> Crear equipo</button> : null}
      </header>
